(function($){
	...
	$.fn.ownConfirm = function(options){
		...
		if (typeof config.action.ok.color === 'undefined') {
			btnY.style = 'padding:5px 10px;text-align:left;background:#4caf50;color:#fff;display:inline-block;margin-right:5px;user-select:none;';
			btnY.onmouseenter = function(){this.style="padding:5px 10px;text-align:left;background:#4caf50;color:#fff;display:inline-block;user-select:none;margin-right:5px;cursor:pointer;opacity:0.8";}
		btnY.onmouseleave = function(){this.style="padding:5px 10px;text-align:left;background:#4caf50;color:#fff;display:inline-block;margin-right:5px;user-select:none;";}
		}else{
		...
		if (typeof config.action.ok.color === 'undefined') {
			btnN.style = 'padding:5px 10px;text-align:left;background:#f44336;color:#fff;;display:inline-block;';
			btnN.onmouseenter = function(){this.style="padding:5px 10px;text-align:left;background:#f44336;color:#fff;display:inline-block;user-select:none;cursor:pointer;opacity:0.8;"}
			btnN.onmouseleave = function(){this.style="padding:5px 10px;text-align:left;background:#f44336;color:#fff;display:inline-block;user-select:none;"}
		}else{
