...
<div class="row">
    <div class="col-md-9">
        <div class="bl-dt">
            ...
            <div class="dt-sta">
                <span>In: @foreach($article[0]->category as $c)<a href="{{ route('ui.category.detail', $c->slug) }}">{{$c->title}}</a>@endforeach</span> <span><i class="fa fa-eye"></i> 10</span> <span><i class="fa fa-heart"></i> 10</span>
            </div>
