...
<div class="row">
    <div class="col-md-12">
        <h3 class="" style="font-weight: 900;text-align: center;margin-bottom: 30px">Đóng góp audio mới</h3>
    </div>
    {!!Form::open(array( 'route' => 'ui.article.upload-audio-store', 'method' => 'POST', 'class' => 'form-horizontal', 'files' => true ))!!}
    <div class="col-md-9">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control @if(!empty($errors->first('auth'))) error-box @endif" name="auth" id="iAuth" placeholder="Tác giả bài hát..." value="{{old('author')}}">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <textarea name="description" id="iDesc" class="form-control @if(!empty($errors->first('description'))) error-box @endif" rows="3"  placeholder="Nhập mô tả ngắn gọn về bài viết...">{{old('description')}}</textarea>
        ...
        <div class="form-group">
            <label for="iAudio" class="col-sm-2 control-label">Ảnh</label>
            <div class="col-sm-10">
