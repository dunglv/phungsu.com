@extends('admin.index') @section('title', 'Thông tin cá nhân') 
@section('b-script')
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">
                Quản lý <small>Thông tin cá nhân</small>
            </h1>
            <ol class="breadcrumb">
                <li class="active">
        ...
        {!!Form::open(array( 'route' => 'ad.u.profile_update', 'method' => 'POST', 'class' => '', 'files' => true ))!!}
            <div class="col-md-10 col-md-offset-1">
                ...
                <div class="panel panel-success">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            <a href="{{ route('ad.u.change-password') }}"><i class="fa fa-lock"></i> <u>Thay đổi mật khẩu đăng nhập</u></a>
                        </div>
                    </div>
                </div>
