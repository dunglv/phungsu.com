...
<div class="row">
    ...
    {!!Form::open(array( 'route' => 'ad.a.create-mp3-store', 'method' => 'POST', 'class' => 'form-horizontal', 'files' => true ))!!}
    <div class="col-md-9">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="file" name="audio" class="form-control @if(!empty($errors->first('audio'))) error-box @endif" id="inputEmail3" placeholder="Email" value="{{old('audio')}}" required="required">
